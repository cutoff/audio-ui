...
import { Ring } from "@cutoff/audio-ui-react";
...
// Wrapper to render the Ring inside an SVG
...
function RingWrapper({
    ...
    // The Ring calculates actualRadius = radius - thickness/2
...
export default function RingDemoPage() {
    ...
    const examples = useMemo(() => [
        ...
        <RingWrapper
            ...
            roundness={1}
            openness={90}
            onClick={() => handleExampleClick({ normalizedValue: 0.5, bipolar: true, thickness: 6, openness: 90, roundness: 1 })}
        />,
        <RingWrapper
            key="full-circle"
        ...
        <RingWrapper
            ...
            roundness={1}
            color="#ec4899" // Pink
            onClick={() => handleExampleClick({ normalizedValue: 0.8, thickness: 12, openness: 120, fgGlow: true, color: "#ec4899", roundness: 1 })}
        />,
    ], [handleExampleClick]);
