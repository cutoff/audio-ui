...
export default function Home() {
    return (
        <div className="min-h-[calc(100dvh-4rem)] md:min-h-screen flex items-center justify-center bg-zinc-900/30 p-4">
            <div className="text-center">
                <h1 className="text-3xl md:text-4xl font-bold mb-4">AudioUI by Cutoff – Playground</h1>
