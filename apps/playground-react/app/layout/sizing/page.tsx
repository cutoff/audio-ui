        ...
        <div className="min-h-screen p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <section className="mb-12">
                    ...
                    <p className="text-muted-foreground mb-6">
                        Sliders maintain consistent track widths across sizes, with height/width ratios of 2:1
                        (vertical) and 1:2 (horizontal).
                    </p>

                    {/* Vertical Slider */}
                    <div className="mb-10">
                        <h3 className="text-xl font-medium mb-4">Vertical Slider (2:1 width:height)</h3>
                    ...
                    {/* Horizontal Slider */}
                    <div className="mb-10">
                        <h3 className="text-xl font-medium mb-4">Horizontal Slider (1:2 width:height)</h3>
                        <div className="flex flex-wrap gap-6 md:gap-8 items-end">
                            {sizeTypes.map((size) => (
                                <div key={size} className="flex flex-col items-center gap-2">
