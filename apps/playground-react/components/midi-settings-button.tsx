...
import { MidiSettingsPanel } from "@/components/midi-settings-panel";
...
/**
 * Custom sheet variants for MIDI settings panel.
 * Configured without overlay to allow real-time preview.
 */
...
interface MidiSheetContentProps extends React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content> {
    side?: "top" | "right" | "bottom" | "left";
}

/**
 * Custom SheetContent component without overlay for MIDI settings.
 * Removes the dark overlay to allow users to preview changes in real-time
 ...
 */
const MidiSheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, MidiSheetContentProps>(
    ({ side = "right", className, children, ...props }, ref) => (
        <SheetPrimitive.Portal>
            {/* No overlay - allows preview of changes */}
...
MidiSheetContent.displayName = "MidiSheetContent";

/**
 * MIDI settings button component for the header.
 * Opens a responsive sheet with MIDI device selection and configuration.
 * - Desktop/Tablet: Right-side sheet (no overlay for preview)
 * - Mobile: Bottom sheet (no overlay for preview)
 * Only renders if WebMidi is supported by the browser.
 *
 * @returns MIDI settings button component or null if not supported
 */
    ...
    return (
        <TooltipProvider>
            <Sheet>
                ...
                >
                    <SheetHeader>
                        <SheetTitle>MIDI Settings</SheetTitle>
                        <SheetDescription>
                            Select a MIDI input device to receive MIDI messages. You can enable or disable WebMidi
                            access here.
                        </SheetDescription>
                    </SheetHeader>
                    <MidiSettingsPanel />
