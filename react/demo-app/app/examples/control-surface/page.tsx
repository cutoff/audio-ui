...
import { Knob, Button, Slider as AudioSlider } from "@cutoff/audio-ui-react";
  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div><span className="font-medium">Filter:</span> {filterValue}</div>
              <div><span className="font-medium">Resonance:</span> {resonanceValue}</div>
              <div><span className="font-medium">Attack:</span> {attackValue}</div>
              <div><span className="font-medium">Release:</span> {releaseValue}</div>
              <div><span className="font-medium">Reverb:</span> {reverbValue}</div>
              <div><span className="font-medium">Delay:</span> {delayValue}</div>
              <div><span className="font-medium">Drive:</span> {driveValue}</div>
              <div><span className="font-medium">Volume:</span> {volumeValue}</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div><span className="font-medium">Slider 1:</span> {slider1Value}</div>
              <div><span className="font-medium">Slider 2:</span> {slider2Value}</div>
              <div><span className="font-medium">Slider 3:</span> {slider3Value}</div>
              <div><span className="font-medium">Slider 4:</span> {slider4Value}</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div><span className="font-medium">Button A:</span> {buttonAValue}</div>
              <div><span className="font-medium">Button B:</span> {buttonBValue}</div>
              <div><span className="font-medium">Button C:</span> {buttonCValue}</div>
              <div><span className="font-medium">Button D:</span> {buttonDValue}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 text-sm text-muted-foreground">
        ...
        <p>All knobs, sliders, and buttons are editable. For knobs and sliders, use the mouse wheel to change their values. For buttons, click to toggle their state.</p>
      </div>
    </div>
  );
}
